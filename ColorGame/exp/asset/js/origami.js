FSS = {FRONT: 0, BACK: 1, DOUBLE: 2, SVGNS: "http://www.w3.org/2000/svg"}, FSS.Array = "function" == typeof Float32Array ? Float32Array : Array, FSS.Utils = {isNumber: function (t) {
...
}, FSS.Vector3 = {create: function (t, e, i) {
...
}}, FSS.Vector4 = {create: function (t, e, i) {
...
}, FSS.Color.prototype = {set: function (t, e) {
    t = t.replace("#", "");
    var i = t.length / 3;
...
}, FSS.Object.prototype = {setPosition: function (t, e, i) {
...
}, FSS.Vertex.prototype = {setPosition: function (t, e, i) {
    return FSS.Vector3.set(this.position, t, e, i), this
...
}, FSS.Scene.prototype = {add: function (t) {
...
}, FSS.Renderer.prototype = {setSize: function (t, e) {
